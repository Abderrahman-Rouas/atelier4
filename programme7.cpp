...
public:
 void set_nom_animal( string n_animal ){nom=n_animal;}  // les fonction pour saisir et lire les valeur des attributs
...
private:
    ...
    string description;
     ...
     list<elments>*lrepas; // une list de type elments
public:
    repas(){lrepas = new list<elments>();}       // get in instance in the A instance because its a composition relation
...
public:
void set_nom1( string n1 ){nom1=n1;}   //des fonction pour saisir et lire les attributs du classe
string get_nom1(){return nom1 ;}
...
class chat : public animal{  //declaration de la classe chat qui hérite depuis la classe animal
private:
 string type ;
 repas chats;   // un attribut de type classe repas
public:
...
private :
    string nom;
    string desciption;
   list<chien> chien1;  // une liste de type chien
public :
...
class chien:public animal,public race {  // declaration de la classe chien qui hérite depuis la classe animal et race
private:
    string taille ;
    list<entraineur>entraineur1;  // une liste de type entraineur
public :
    void ischass3(){ cout<<"i'am ischass3"<<endl;};  // les fonctions pour saisir et lire les attributs
...
public:
   int ordre;
    entraineur ent;   // variable de type de classe entraineur
    chien   chie;      // variable de type de classe chien
